...
router.get("/", (req, res) => {
    ...
    res.render('users/register', { usersession: req.session.user, links: topbardata, isalert: false });
});
...
router.get("/:alert", (req, res) => {
    ...
    res.render('users/register', { usersession: req.session.user, links: topbardata, isalert: true, alert: req.params.alert });
});
